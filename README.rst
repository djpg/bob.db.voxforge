...
.. image:: http://img.shields.io/badge/docs-v2.3.0-yellow.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.db.voxforge/v2.3.0/index.html
.. image:: http://img.shields.io/badge/docs-latest-orange.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.db.voxforge/master/index.html
.. image:: https://gitlab.idiap.ch/bob/bob.db.voxforge/badges/v2.3.0/build.svg
   :target: https://gitlab.idiap.ch/bob/bob.db.voxforge/commits/v2.3.0
.. image:: https://gitlab.idiap.ch/bob/bob.db.voxforge/badges/v2.3.0/coverage.svg
   :target: https://gitlab.idiap.ch/bob/bob.db.voxforge/commits/v2.3.0
